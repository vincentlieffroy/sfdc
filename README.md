...
1. Fill in the config variables as described.
    ...
    - For **SF_USER_NAME**, enter the the username of your Salesforce integration user. On this user's profile, you need to ensure that :
    		- the IP addresses ranges of the Login IP Ranges is set from 0.0.0.0 to 255.255.255.255
    		- the 'API enabled' checkbox system permission is checked 
